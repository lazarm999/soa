...
def postSong():
    if request.json['_id'] is None or request.json['name'] is None or \
        request.json['album'] is None or request.json['artists'] is None or \
        request.json['release_date'] is None:
        abort(400)
    else:
